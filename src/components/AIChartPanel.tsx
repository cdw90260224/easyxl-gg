...
export default function AIChartPanel({ data, chartConfig, onClose }: AIChartPanelProps) {
    ...
    return (
        <div className="bg-white dark:bg-[#1a1a1a] border border-gray-100 dark:border-gray-800 rounded-2xl shadow-2xl shadow-indigo-500/10 dark:shadow-none overflow-hidden animate-in fade-in zoom-in-95 duration-500">
            {/* Header */}
            <div className="flex items-center justify-between p-5 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-deepblue-50 to-purple-50 dark:from-deepblue-950/30 dark:to-purple-950/30">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-deepblue-500 to-deepblue-700 flex items-center justify-center shadow-lg shadow-deepblue-500/30">
