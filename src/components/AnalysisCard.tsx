...
const intentColor: Record<string, string> = {
    calculation: 'from-deepblue-600 to-deepblue-800',
    filtering: 'from-blue-600 to-cyan-600',
    update: 'from-emerald-600 to-teal-600',
    generation: 'from-pink-600 to-rose-600',
};
...
export default function AnalysisCard({ analysis }: { analysis: any }) {
    ...
    const gradient = intentColor[analysis.intent] ?? 'from-deepblue-600 to-deepblue-800';
