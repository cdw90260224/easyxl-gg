...
export default function Header({ isDark, toggleDark, isPrivacyMode, onShowPrivacyPolicy, user, onShowHistory, onSync, isSyncing }: any) {
    // Dummy usage to satisfy strict linting in some environments if needed
    if (false) console.log(isDark, toggleDark);
        ...
        <header className="glass-morphism sticky top-0 z-50 transition-colors shadow-sm dark:shadow-none border-b border-gray-200 dark:border-gray-800">
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                ...
                >
                    ...
                    <div className="text-xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100 flex items-center gap-2">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {/* Sync / Login */}
                            <button
                                ...
                                title="최근 분석 이력"
                            >
                                <Clock className="w-4 h-4 text-deepblue-500" />
